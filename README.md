...
<!-- ▶️ ДЕМО. Чтобы включить ВСТРОЕННЫЙ видеоплеер вместо постера ниже:
     ...
     2. GitHub загрузит видео и подставит ссылку вида
        https://github.com/user-attachments/assets/ХХХХХХХХ
     3. Замени блок с постером ниже на эту ссылку отдельной строкой (GitHub сам отрисует
        плеер), либо на тег:
