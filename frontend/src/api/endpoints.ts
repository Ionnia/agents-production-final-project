...
export const client = createClient({ baseUrl: import.meta.env.VITE_API_BASE || '/api/v1', getToken: () => tokenGetter(), fetch: (...args: Parameters<typeof fetch>) => globalThis.fetch(...args) })
