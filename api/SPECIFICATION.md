...
**Status:** Contract defined (design approved); not yet implemented.
...
travel-planning agent backend. It is the hand-off artifact other team members implement against; no
server or client code lives here yet.
